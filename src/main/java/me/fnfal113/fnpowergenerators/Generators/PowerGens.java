package me.fnfal113.fnpowergenerators.Generators;
...
import me.fnfal113.fnpowergenerators.ItemsFN;
...
public class PowerGens extends SlimefunItem implements InventoryBlock, EnergyNetProvider {

    static ConfigValues value = new ConfigValues();
    ...
    public PowerGens(Type type) {
        super(ItemsFN.FNPOWERGENERATORS, type.getItem(), RecipeType.ENHANCED_CRAFTING_TABLE, type.getRecipe());
        this.type = type;
    ...
    public enum Type {
        ...
        RANK1(ItemsFN.FN_XPANSION_POWER_R1, FN_POWERGEN_RANK_I_DAYRATE, FN_POWERGEN_RANK_I_NIGHTRATE, FN_POWERGEN_RANK_I_OUTPUT,
        ...
        RANK2(ItemsFN.FN_XPANSION_POWER_R2, FN_POWERGEN_RANK_II_DAYRATE, FN_POWERGEN_RANK_II_NIGHTRATE, FN_POWERGEN_RANK_II_OUTPUT,
                FN_POWERGEN_RANK_II_STORAGE, new ItemStack[] {
                Items.IRIDIUM, ItemsFN.FN_XPANSION_POWER_R1, Items.IRIDIUM,
                Items.MACHINE_BLOCK, Items.REINFORCED_GLASS, Items.MACHINE_BLOCK,
                SlimefunItems.BASIC_CIRCUIT_BOARD, Items.IRON_ITEM_CASING, SlimefunItems.BASIC_CIRCUIT_BOARD
        }),

        RANK3(ItemsFN.FN_XPANSION_POWER_R3, FN_POWERGEN_RANK_III_DAYRATE, FN_POWERGEN_RANK_III_NIGHTRATE, FN_POWERGEN_RANK_III_OUTPUT,
                FN_POWERGEN_RANK_III_STORAGE, new ItemStack[] {
                Items.IRIDIUM, ItemsFN.FN_XPANSION_POWER_R2, Items.IRIDIUM,
                Items.MACHINE_BLOCK, Items.REINFORCED_GLASS, Items.MACHINE_BLOCK,
                SlimefunItems.BASIC_CIRCUIT_BOARD, Items.IRON_ITEM_CASING, SlimefunItems.BASIC_CIRCUIT_BOARD
        }),

        RANK4(ItemsFN.FN_XPANSION_POWER_R4, FN_POWERGEN_RANK_IV_DAYRATE, FN_POWERGEN_RANK_IV_NIGHTRATE, FN_POWERGEN_RANK_IV_OUTPUT,
                FN_POWERGEN_RANK_IV_STORAGE, new ItemStack[] {
                Items.IRIDIUM, ItemsFN.FN_XPANSION_POWER_R3, Items.IRIDIUM,
                Items.MACHINE_BLOCK, Items.REINFORCED_GLASS, Items.MACHINE_BLOCK,
                SlimefunItems.BASIC_CIRCUIT_BOARD, Items.GOLD_ITEM_CASING, SlimefunItems.BASIC_CIRCUIT_BOARD
        }),

        RANK5(ItemsFN.FN_XPANSION_POWER_R5, FN_POWERGEN_RANK_V_DAYRATE, FN_POWERGEN_RANK_V_NIGHTRATE, FN_POWERGEN_RANK_V_OUTPUT,
                FN_POWERGEN_RANK_V_STORAGE, new ItemStack[] {
                Items.IRIDIUM, ItemsFN.FN_XPANSION_POWER_R4, Items.IRIDIUM,
        ...
        RANK6(ItemsFN.FN_XPANSION_POWER_R6, FN_POWERGEN_RANK_VI_DAYRATE, FN_POWERGEN_RANK_VI_NIGHTRATE, FN_POWERGEN_RANK_VI_OUTPUT,
                FN_POWERGEN_RANK_VI_STORAGE, new ItemStack[] {
                Items.IRIDIUM_PLATE, ItemsFN.FN_XPANSION_POWER_R5, Items.IRIDIUM_PLATE,
        ...
        RANK7(ItemsFN.FN_XPANSION_POWER_R7, FN_POWERGEN_RANK_VII_DAYRATE, FN_POWERGEN_RANK_VII_NIGHTRATE, FN_POWERGEN_RANK_VII_OUTPUT,
                FN_POWERGEN_RANK_VII_STORAGE, new ItemStack[] {
                Items.IRIDIUM_PLATE, ItemsFN.FN_XPANSION_POWER_R6, Items.IRIDIUM_PLATE,
                Items.ADVANCED_MACHINE_BLOCK, Items.ADVANCED_ALLOY, Items.ADVANCED_MACHINE_BLOCK,
                SlimefunItems.ADVANCED_CIRCUIT_BOARD, Items.TIN_CABLE, SlimefunItems.ADVANCED_CIRCUIT_BOARD
        }),

        RANK8(ItemsFN.FN_XPANSION_POWER_R8, FN_POWERGEN_RANK_VIII_DAYRATE, FN_POWERGEN_RANK_VIII_NIGHTRATE, FN_POWERGEN_RANK_VIII_OUTPUT,
                FN_POWERGEN_RANK_VIII_STORAGE, new ItemStack[] {
                Items.IRIDIUM_PLATE, ItemsFN.FN_XPANSION_POWER_R7, Items.IRIDIUM_PLATE,
                Items.ADVANCED_MACHINE_BLOCK, Items.THORIUM_PLATE, Items.ADVANCED_MACHINE_BLOCK,
                SlimefunItems.ADVANCED_CIRCUIT_BOARD, ItemsFN.FN_XPANSION_POWER_R5, SlimefunItems.ADVANCED_CIRCUIT_BOARD
        }),

        RANK9(ItemsFN.FN_XPANSION_POWER_R9, FN_POWERGEN_RANK_IX_DAYRATE, FN_POWERGEN_RANK_IX_NIGHTRATE, FN_POWERGEN_RANK_IX_OUTPUT,
                FN_POWERGEN_RANK_IX_STORAGE, new ItemStack[] {
                Items.IRIDIUM_PLATE, ItemsFN.FN_XPANSION_POWER_R8, Items.IRIDIUM_PLATE,
                Items.ADVANCED_MACHINE_BLOCK, Items.LAPOTRON_CRYSTAL, Items.ADVANCED_MACHINE_BLOCK,
                SlimefunItems.ADVANCED_CIRCUIT_BOARD, ItemsFN.FN_XPANSION_POWER_R5, SlimefunItems.ADVANCED_CIRCUIT_BOARD
        }),

        RANK10(ItemsFN.FN_XPANSION_POWER_R10, FN_POWERGEN_RANK_X_DAYRATE, FN_POWERGEN_RANK_X_NIGHTRATE, FN_POWERGEN_RANK_X_OUTPUT,
                FN_POWERGEN_RANK_X_STORAGE, new ItemStack[] {
                Items.IRIDIUM_PLATE, ItemsFN.FN_XPANSION_POWER_R9, Items.IRIDIUM_PLATE,
                Items.MULTI_FUNCTIONAL_ELECTRIC_STORAGE_UNIT, Items.LAPOTRON_CRYSTAL, Items.MULTI_FUNCTIONAL_ELECTRIC_STORAGE_UNIT,
                SlimefunItems.ADVANCED_CIRCUIT_BOARD, ItemsFN.FN_XPANSION_POWER_R5, SlimefunItems.ADVANCED_CIRCUIT_BOARD
        }),

        RANK11(ItemsFN.FN_XPANSION_POWER_R11, FN_POWERGEN_RANK_XI_DAYRATE, FN_POWERGEN_RANK_XI_NIGHTRATE, FN_POWERGEN_RANK_XI_OUTPUT,
                FN_POWERGEN_RANK_XI_STORAGE, new ItemStack[] {
                Items.IRIDIUM_PLATE, ItemsFN.FN_XPANSION_POWER_R10, Items.IRIDIUM_PLATE,
                Items.MULTI_FUNCTIONAL_ELECTRIC_STORAGE_UNIT, Items.LAPOTRON_CRYSTAL, Items.MULTI_FUNCTIONAL_ELECTRIC_STORAGE_UNIT,
                SlimefunItems.ADVANCED_CIRCUIT_BOARD, ItemsFN.FN_XPANSION_POWER_R5, SlimefunItems.ADVANCED_CIRCUIT_BOARD
        }),

        RANK12(ItemsFN.FN_XPANSION_POWER_R12, FN_POWERGEN_RANK_XII_DAYRATE, FN_POWERGEN_RANK_XII_NIGHTRATE, FN_POWERGEN_RANK_XII_OUTPUT,
                FN_POWERGEN_RANK_XII_STORAGE, new ItemStack[] {
                Items.IRIDIUM_PLATE, ItemsFN.FN_XPANSION_POWER_R11, Items.IRIDIUM_PLATE,
                Items.MULTI_FUNCTIONAL_STORAGE_UNIT, Items.LAPOTRON_CRYSTAL, Items.MULTI_FUNCTIONAL_STORAGE_UNIT,
                SlimefunItems.ADVANCED_CIRCUIT_BOARD, ItemsFN.FN_XPANSION_POWER_R7, SlimefunItems.ADVANCED_CIRCUIT_BOARD
        }),
